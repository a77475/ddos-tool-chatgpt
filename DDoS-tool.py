...
class DDOSTool:
    def __init__(self, master):
        ...
        self.scale_duration = ttk.Scale(master, from_=1, to=2678400, length=200, orient=tk.HORIZONTAL)
        self.scale_duration.grid(row=3, column=1, padx=10, pady=10)
    ...
    def start_ddos(self):
        ...
        duration = int(self.scale_duration.get())
